function Player(css, layer, source, spd, world, animations)
{
  ...
  {
	this._index++;
	if(this._index >= this.sprite.data.frames[this.currentAnimation].length)this._index = 0;
  ...
  this.drawSprite = function(i)
  {
	...
	(
	this.sprite.image,
	this.worldX() - this.width()/2 - this.sprite.data.frames[this.currentAnimation][_i].frame.x*this.scaleX,
	this.worldY() - this.height()/2 - this.sprite.data.frames[this.currentAnimation][_i].frame.y*this.scaleY, this.sprite.width(), 
	this.sprite.height()
	);
	this.ctx.restore();
  }
 ...
 this.fixedVX = function()
  ...
  this.top = (function(me)
  {
  	    return {
  		get:function(){return{x:me.worldX(),y:me.worldY()-me.height()/2};},
  		isHitting:function(obj){ return me.checkCollision(this.get(), obj); },
  		stop:function(){me.stopY(1)},
  		spd:-me.spd
  	}
  })(this);
  
  this.bottom = (function(me)
  {
  	    return {
  		get:function(){return{x:me.worldX(),y:me.worldY()+me.height()/2};},
  		isHitting:function(obj){ return me.checkCollision(this.get(), obj); },
   ...
   /*this.bottom = (function(me)
  {
  	var direction = -1;
  	function get(){ 
  		return {x:me.worldX(),y:me.worldY()+me.height()/2}
  		};
  	    return {
  		get:function(){point = {x:me.worldX(),y:me.worldY()+me.height()/2};
  					   return point;},
  		isHitting:function(obj){ return me.checkCollision(get(), obj); },
  		stop:function(){me.stopY(direction)}
  	}
  })(this);*/
  
 this.right = (function(me)
  {
  	    return {
  		get:function(){return{x:me.worldX()+me.width()/2,y:me.worldY()};},
  		isHitting:function(obj){ return me.checkCollision(this.get(), obj); },
  		stop:function(){me.stopX(-1)},
  		spd:me.spd
  	}
  })(this);
  
  this.left = (function(me)
  {
  	    return {
  		get:function(){return{x:me.worldX()-me.width()/2,y:me.worldY()};},
  		isHitting:function(obj){ return me.checkCollision(this.get(), obj); },
  ...
  this.points = function(){return[this.top.get(), this.bottom.get(), this.left.get(), this.right.get()];}
  ...
  this.isHitting = function(object)
  {
	if(this.bottom.get().y > object.top().y && this.top.get().y < object.bottom().y &&
	   this.left.get().x < object.right().x && this.right.get().x > object.left().x) 
	{
		return true;
	}
	else
